...
class InventoryServiceTest {
    ...
    void removeStock_Insufficient_ThrowsBadRequest() {
        ...
        Inventory inv = new Inventory(); inv.setId(9L); product.setOrganizationId(1L); inv.setProduct(product); inv.setProductId(5L); inv.setQuantity(BigDecimal.valueOf(2)); inv.setAdjustedPrice(BigDecimal.ONE); inv.setUpdatedAt(OffsetDateTime.now());
        when(productRepository.findById(5L)).thenReturn(Optional.of(product));
